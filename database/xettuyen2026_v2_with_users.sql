...
-- UPDATED VERSION WITH USER/ROLE TABLES
...
--
-- Table structure for table `xt_nguoidung` (NEW - User Management)
--
...
CREATE TABLE `xt_nguoidung` (
  ...
  `taikhoan` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  `dienthoai` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `phanquyen` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'user',
...
INSERT INTO `xt_nguoidung` VALUES (1,'admin','admin123','Administrator','admin@sgu.edu.vn','0123456789','admin',1,NOW(),NOW());
INSERT INTO `xt_nguoidung` VALUES (2,'user01','user123','User 01','user01@sgu.edu.vn','0987654321','user',1,NOW(),NOW());
